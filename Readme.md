...
* Студент: [Марина Лопатникова](https://up.htmlacademy.ru/htmlcss/26/user/224291).
* Наставник: `Дима Коварда`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/224291-sedona-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
